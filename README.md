...
- Production-style ETL/ELT pipelines with orchestration, validation, and monitoring
- Data warehouse models, dimensional marts, and analytics-ready reporting layers
- Airflow, dbt, Snowflake, PostgreSQL, Databricks, Docker, and AWS-based data workflows
- Data quality, reconciliation, lineage, and reliability checks for trusted downstream reporting
- Applied AI and retrieval-based data products when they strengthen the user workflow
...
- **Oracle Analytics Intern, Calix:** optimized Oracle ERP reporting workflows, tuned complex SQL, and automated scheduled reporting workflows for Finance and Supply Chain stakeholders.
- **Technical Analyst, Oracle India GBF Systems:** owned production ETL pipelines, transformed revenue/bookings/KPI data into warehouse datasets, and supported reporting layers across enterprise use cases.
- **Recognition:** received 4 Oracle Vision Awards and top 5% recognition for ownership of production data pipelines and incident recovery.
- **Education:** MS Data Science, Illinois Institute of Technology; BTech Computer Science Engineering, Dayananda Sagar University.

## Contact

- Email: [ananyabpgayathri25@gmail.com](mailto:ananyabpgayathri25@gmail.com)
- LinkedIn: [gayathri-ananya-175584174](https://www.linkedin.com/in/gayathri-ananya-175584174)
- GitHub: [bananya007](https://github.com/bananya007)
